...
const projects = [
  ...
  { title: "SeeBlank", desc: "Developed a full-stack movie platform using React and FastAPI that allows users to browse and explore media content through a responsive and visually engaging interface.",                       tech: ["Python", "OpenAI API", "Stripe", "PostgreSQL"],      github: "https://github.com/parth-godhani48/SeeBlank.git", live: "#", image: "https://imgs.search.brave.com/qcbdmiEY6h_Dd925dTdUFnfvSvfj6x0JFl-EjAo_khU/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL00v/TVY1Qk56STRZamt5/T0RjdE1HSm1OQzAw/WWpCakxUbGxOakF0/TkRreE5USm1aamc0/TUdaa1hrRXlYa0Zx/Y0djQC5qcGc" },
  { title: "Portfolio Website",   desc: "This very portfolio — built with Next.js, Tailwind CSS, and Framer Motion for smooth animations.",                   tech: ["Next.js", "Tailwind CSS", "Framer Motion"],  github: "https://github.com/parth-godhani48/portfolio.git", live: "", image: "https://images.unsplash.com/photo-1545239351-ef35f43d514b?auto=format&fit=crop&w=800&q=80" },
